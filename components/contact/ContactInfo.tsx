        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-200">contacto@thepilgrim.com</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-200">+34 600 000 000</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card p-8">
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-200">Todos los días</p>
          </div>
        </div>
